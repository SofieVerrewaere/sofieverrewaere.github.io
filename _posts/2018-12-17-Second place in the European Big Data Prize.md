...
* <b>Zero model MLP</b>: This MLP predicts the probability of the values being zero (0/1).
* <b>Continuous model MLP</b>: This MLP predicts the continuous targets (the change). The last layer weights of the change model are initialized near zero. Close to persistence as starting point instead of random change predictions.
